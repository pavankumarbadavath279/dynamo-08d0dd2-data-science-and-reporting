...
Requires the [GitHub CLI](https://cli.github.com/) (`gh`). Replace `dynamo-08d0dd2-data-science-and-reporting`
with the repository you were assigned:

```bash
gh repo fork handshake-project-dynamo/dynamo-08d0dd2-data-science-and-reporting --clone
cd dynamo-08d0dd2-data-science-and-reporting
git checkout -b submission
#  ... build the task (see below) ...
git add -A && git commit -m "Task submission"
git push -u origin submission
gh pr create --repo handshake-project-dynamo/dynamo-08d0dd2-data-science-and-reporting --fill
```
...
Org repo PR validation line for new-feature-9
